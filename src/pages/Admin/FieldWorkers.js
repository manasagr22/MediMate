...
const SeeWorkers = (props) => {
  ...
  return (
    <div>
      <NavbarAd checkToken={props.checkToken} page={"workers"} setJwtToken={props.setJwtToken} jwtToken={props.jwtToken} decryptData={props.decryptData} handleAlert={props.handleAlert} setBackground={props.setBackground} setLoad={props.setLoad}/>
