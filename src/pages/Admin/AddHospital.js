...
const AddHospital = (props) => {
    ...
    <option value="DE">Germany</option>
                    ...
                    <div>
                        <label for="location" class="block text-sm w-fit font-medium text-gray-900 dark:text-white">Sub Division</label>
                        <select id="sub division" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
